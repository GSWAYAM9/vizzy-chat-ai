"""
Deckoviz Backend - Django Settings
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='deckoviz'),
...
# File Upload Configuration - Optimized for multipart uploads
...
ROOT_URLCONF = 'deckoviz_backend.urls'
...
WSGI_APPLICATION = 'deckoviz_backend.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='deckoviz_db'),
        'USER': config('DB_USER', default='postgres'),
